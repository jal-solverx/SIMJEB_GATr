...
class Trainer():
    ...
    def process_data(self, cfg):
        ...
        for sample_idx in train_sample_id:
            ...
            with h5py.File(file_path, 'r') as file:
                ...
                rbe3_onehot = 2 * one_hot_from_rbe(rbe3, N)
                ...
                bc = rbe2_onehot + rbe3_onehot #[N , 1]
    ...
    def make_model_components(self, cfg: DictConfig):
        ...
        self.scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(self.optimizer, factor = cfg.scheduler.lr_decay, patience = cfg.scheduler.lr_patience)
